      ...
      <section className={styles.sec4} id='section4'>
            ...
            <ContainerV1 className={styles.wrapper}>
               <article className={styles.titleBox}>
                  <div className={styles.title}>
                     <span className={clsx(styles.step_txt, 'poppins')}>step 1</span>
         ...
         <div className={clsx(styles.sec_wrapper, styles.step2)}>
            <ContainerV1 className={styles.wrapper}>
               <article className={styles.titleBox}>
                  <div className={styles.title}>
                     <span className={clsx(styles.step_txt, 'poppins')}>step 2</span>
                     <h2 className='paperLogy'>
                         24시간 관제 + <br />
         ...
         <div className={clsx(styles.sec_wrapper, styles.step3)}>
            <ContainerV1 className={styles.wrapper}>
               <article className={styles.titleBox}>
                  <div className={styles.title}>
                     <span className={clsx(styles.step_txt, 'poppins')}>step 3</span>
                     <h2 className='paperLogy'>
                         무재고 위탁 시스템으로 <br />
