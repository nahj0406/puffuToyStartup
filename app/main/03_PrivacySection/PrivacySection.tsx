               ...
               <div className={styles.itemBox}>
                  ...
                  >
                     <figure className={styles.img}>
                        <img src="/img/privacy/privacy_step1_icon01.png" alt="privacy_아이콘" />
                     </figure>
                  ...
                  >
                     <figure className={styles.img}>
                        <img src="/img/privacy/privacy_step1_icon02.png" alt="privacy_아이콘" />
                     </figure>
                  ...
                  >
                     <figure className={styles.img}>
                        <img src="/img/privacy/privacy_step1_icon03.png" alt="privacy_아이콘" />
                     </figure>
                  ...
                  >
                     <figure className={styles.img}>
                        <img src="/img/privacy/privacy_step1_icon04.png" alt="privacy_아이콘" />
                     </figure>
         ...
         <div className={clsx(styles.sec_wrapper, styles.step2)}>
            <ContainerV1 className={styles.wrapper}>
               ...
               <div className={styles.itemBox}>
                  ...
                  >
                     <figure className={styles.img}>
                        <img src="/img/privacy/privacy_step2_icon01.png" alt="privacy_아이콘" />
                     </figure>
                  ...
                  >
                     <figure className={styles.img}>
                        <img src="/img/privacy/privacy_step2_icon02.png" alt="privacy_아이콘" />
                     </figure>
         ...
         <div className={clsx(styles.sec_wrapper, styles.step3)}>
            <ContainerV1 className={styles.wrapper}>
               ...
               <div className={styles.itemBox}>
                  ...
                  >
                     <figure className={styles.img}>
                        <img src="/img/privacy/privacy_step3_icon01.png" alt="privacy_아이콘" />
                     </figure>
                  ...
                  >
                     <figure className={styles.img}>
                        <img src="/img/privacy/privacy_step3_icon02.png" alt="privacy_아이콘" />
                     </figure>
